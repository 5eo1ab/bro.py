...
comp_code_dict = mk_comp_code_dict('SSE50Index_wiki.xlsx')    
...
for key in not_ched_list:
    ...
    while True:
        ...
        price_info_df.to_csv('SSE50'+'\\'+str(comp_code_dict[key])+'_'+str(key)+'.csv', index=False)
    prd_cor.append(key)


print(err_text)
with open('SSE50\\err_text.txt', "w") as err:
    err.write(err_text)

...
for period in period_list:
    ...
    for indexnm in index_file:
        ...
        if not os.path.exists(directory+"\\Modeling_RawData_"+read_directory[-5:-3]):
                os.makedirs(directory+"\\Modeling_RawData_"+read_directory[-5:-3])
                
        rm_data.to_csv(directory+"\\Modeling_RawData_"+read_directory[-5:-3]+ "\\Modeling_dataset_" + indexnm[18:])
